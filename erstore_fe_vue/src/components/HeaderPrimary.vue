          ...
          <div class="col-xl-4 col-lg-4">
            <div class="header-info header-info-right">
              <ul>
                <li v-if="currentUser">
                  <a class="language-dropdown-active" href="#">
                    Xin chào, {{ currentUser.name }} <i class="fi-rs-angle-small-down"></i
                  ></a>
                  <ul class="language-dropdown" style="min-width: 200px">
                    ...
                    <li>
                      <a href="#" class="text-danger" @click="logout"
                        ><i class="fi-rs-exit"></i> Đăng xuất</a
                      >
                    </li>
                  </ul>
                </li>
                <li class="account" v-else>
...
export default {
  ...
  methods: {
    ...
    logout() {
      ...
      // Optionally, you can also reset user state in Pinia store if needed
